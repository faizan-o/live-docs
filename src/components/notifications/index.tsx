  ...
  return (
    <Popover>
      ...
      <PopoverContent>
        ...
        >
          <InboxNotificationList className="focus:outline-none focus:border-none focus:ring-0">
            ...
            {unreadNotifications.length > 0 &&
              unreadNotifications.map((notification: InboxNotificationData) => (
                <InboxNotification
                  key={notification.id}
